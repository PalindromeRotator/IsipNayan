...
public class QuestionScriptQ3 : MonoBehaviour
{
    ...
    AnswerObject[] answer = new AnswerObject[]{
        ...
        new AnswerObject {
            qnumber = "18",
            choice1 = "A. 254.34 cm^2",
            choice2 = "B. 254.44 cm^2",
            choice3 = "C. 254.54 cm^2",
            choice4 = "D. 254.64 cm^2",
            rightAnswer = "A. 254.34 cm^2",
            explanation = "",
        },
        new AnswerObject {
            qnumber = "19",
    ...
    string[] questions = new string[] {
        ...
        "is a heptagon has 6 sides ?",
        "What is a polygon with eight vertices?",
        "The middle point of the circle is ?",
        ...
        "37, 39, 41, 43, 45",
        "2m + 6 = 3m -9",
        "What time in turkey if it is 9:00 pm in the Philippines?",
        "In terms of radius, a diameter is equals to:",
        "What is 1635 when converted to 12hrs. time",
        "A circle has diameter 22 cm. What is the radius?",
        "A cylindrical can has a diameter of 2 inches, what will be the circumference of the can?",
        "A cow is tied to a mango tree in the farm. The rope is 2.9m long. How many meters around the tree can the cow walk?",
        "The diameter of circle is 10.4 centimeters. what is its area?",
        "20.20% is equivalent to what fraction?",
        "What is 50% of 34?",
        "A polygon with seven sides is a ?",
        "If the radius of a circle is 2, what is the diameter?",
        "it is the longest segment between two points of a circle",
        "What is the rule of the sequence 3,7,11,15?",
        "What is the decimal form of 78%?",
        "What is the percent form of 0.6789?",
        "What is the percent form of 1/2?",
        "It is a plane figure but is not considered as polygon?",
