...
public class QuestionScriptQ2 : MonoBehaviour
{
    ...
    string[] questions = new string[] {
        ...
        "Compare the decimal by choosing the right inequality sign: 1.96 ____ 0.95",
        "Which is the greatest decimal number?",
        "After spending Php 23.25, Matthew still has Php 49.50 left. How much did Matthew start with? What is asked in the problem?",
        ...
        "What is  0.34 × 42?",
        "What is 0.26 × 6?",
        "Estimate the product: 8.05 x 10.20",
        "Estimate the product: 4.25 x 6.30",
        "Dividing 12 by 15 is:",
        "Find the quotient: 4.8 ÷ 3",
        "What is the ratio of 6 battery packs to 5 cellphones?",
        "What is the ratio of 12 earphones to 6 players?",
        "Express the ratio 22:66 in simplest form.",
        "Express the ratio 4:6 in simplest form.",
        ...
        "Round-off 812.3845 to the nearest hundredths.",
        "What is 42.05 + 13.319?",
        "What is 2.35 × 5?",
        "What is 3 x 8?",
        "Find the quotient of 24.6 and 6.",
        "Find the quotient of 0.5436 and 6.",
        "Give the place value of 1 in 43.816.",
        "Give the place value of 2 in 101.3492.",
        "Compare the given decimals 8.3 and 8.3000 by >,< or =.",
        "Compare the given decimals 2.699 and 2.7 by >,< or =.",
        "Perform the indicated operation: 3.6 + 1.281.",
    };
    void Start()
    {
