...
public class QuestionScriptQ4 : MonoBehaviour
{
    ...
    AnswerObject[] answer = new AnswerObject[]{
        ...
        new AnswerObject {
            qnumber = "6",
            choice1 = "A. 0.015386 cm",
            choice2 = "B. 0.015934 cm^2",
            choice3 = "C. 0.015349 cm^2",
            choice4 = "D. 0.015943 cm",
            rightAnswer = "D. 0.015943 cm",
        ...
        new AnswerObject {
            qnumber = "10",
            choice1 = "A. 6 804 dam^3",
            choice2 = "B. 6048 dam^3",
            choice3 = "B. 6048 dam^3",
            choice4 = "D. 6480 dam^3",
        ...
        new AnswerObject {
            qnumber = "12",
            choice1 = "A. 3 225 dm^3",
            choice2 = "B. 322.5 cm^3",
            choice3 = "C. 32.25 cm^3",
    ...
    string[] questions = new string[] {
        "Find the area covered by the base of an electric fan if its circular base has a radius of 15 ",
        ...
        "4 L is equal to how many cL?",
        "It is a liquid that rises and falls when there is a change in temperature.",
        "A device that measures body temperature.",
        "Using π = 3.14, calculate the area given the diameter 0.14 m",
        "How much is 250 ml in liters?",
        "Solve for the volume of a shoebox whose length, width, and height is 36 cm, 20 cm, and 16 cm respectively.",
        "If a printer cartridge has a 15-cm length, 8-cm width, and 10-cm height, what is its volume?",
        "24 dam × 18 dam × 14 dam ?",
        "A rectangular block of wood is 16 cm long, 12 cm wide, and 5 cm thick. What is its volume?",
        "Beth's sewing box is 3 dm long, 2.5 dm wide and 4.3 dm high. What is its volume?",
        "A gadget has a volume of 80 cm³. Its length and width is 4 cm and 10 cm respectively. What is its height?",
        ...
        "The second step in creating a line graph is _ . ?",
        "These are evidence-based guesses by observing facts then conclusion.",
        "the following are the steps in solving routine and non-routine problems using data ",
        ...
        "Find the volume of Chocolate drink ( Length-5cm, Width- 3cm, Height- 8.5 cm )",
